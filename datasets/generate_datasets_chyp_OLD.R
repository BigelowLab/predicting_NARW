...
comparison_chyp <- readr::read_csv(file.path(root, "tc_datasets/ae_dryweight_nooutliers_chyp.csv.gz"))
...
# Saving to files
readr::write_csv(ae_dw_nooutliers, file = file.path(root, "11_25_finaldraft/chyperboreus.csv.gz"))
