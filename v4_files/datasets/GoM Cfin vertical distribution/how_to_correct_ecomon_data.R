...
root <- "/mnt/ecocast/projects/students/ojohnson/brickman/datasets/GoM Cfin vertical distribution"

# choose CV-CVI or CIV_CVI
load(file = file.path(root, "Cfin_CIV_CVIgamms3_4_remove01.RData"))
